...
export class Game {
    ...
    private controlBlock: ControlBlock | undefined;

    public connect(grid: Grid): void {
        this.grid = grid;
    }
    ...
    public rotateClock(): void {
        ...
        let lastRotatePosition = this.controlBlock.rotateClock();
        this.updateControlBlockPosition(lastRotatePosition);
        this.update();
    }

    public rotateAntiClock(): void {
        if (this.controlBlock === undefined) {
            throw "No control block exist";
        }
        if (this.grid === undefined) {
        ...
        let lastRotatePosition = this.controlBlock.rotateAntiClock();
        this.updateControlBlockPosition(lastRotatePosition);
        this.update();
    }

    private updateControlBlockPosition(lastRotation: "top" | "left" | "bottom" | "right"): void {
        if (this.controlBlock === undefined) {
            throw "No control block exist";
        }
        if (this.grid === undefined) {
    ...
    private addBlock(): void {
        ...
        this.controlBlock = new ControlBlock(this.grid.width);
